...
public class Project
{
	public static void main(String args[])
	{
		...
		System.out.println("DO YOU WANT BASIC PROGRAMS OF JAVA OR LAB EXPERIMENTS IN JAVA:");
		...
		if(ch==1)
{
		...
		System.out.println("DO U WANT TO CONTINUE IN BASIC PROGRAMS:(Y/N):");
		b=s.nextChar();
		if(b=='y')
			u=1;
		else
		...
		while(o==1)
{
		...
		System.out.println("DO U WANT TO CONTINUE IN LAB EXPERIMENTS:(Y/N)");
		a=s.nextChar();
		if(a=='y')
			o=1;
		else
		...
		System.out.println("DO U WANT TO CHOOSE BETWEEN LAB EXPERIMENTS AND BASIC PROGRAMS OF JAVA:(y/n):");
		c=s.next().charAt(0);
		if(c=='y')
			f=1;
		else
